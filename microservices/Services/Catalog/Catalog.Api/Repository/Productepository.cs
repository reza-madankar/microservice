...
{
    public class Productepository : IProductRepository
    {
        private readonly ICatalogContext _context;
        public Productepository(ICatalogContext context)
        {
            _context = context;
        }
        ...
        public async Task<IEnumerable<Product>> GetProductsByCatategory(string category)
        {
